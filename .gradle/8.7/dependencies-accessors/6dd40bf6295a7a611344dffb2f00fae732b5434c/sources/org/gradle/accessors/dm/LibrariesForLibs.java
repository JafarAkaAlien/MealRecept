...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>okhttp</b> with <b>com.squareup.retrofit2:okhttp</b> coordinates and
    ...
    public static class AndroidxRoomCompilerLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRoomCompiler2LibraryAccessors laccForAndroidxRoomCompiler2LibraryAccessors = new AndroidxRoomCompiler2LibraryAccessors(owner);

        public AndroidxRoomCompilerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.room.compiler.2</b>
         */
        public AndroidxRoomCompiler2LibraryAccessors get2() {
            return laccForAndroidxRoomCompiler2LibraryAccessors;
        }

    }

    public static class AndroidxRoomCompiler2LibraryAccessors extends SubDependencyFactory {
        private final AndroidxRoomCompiler26LibraryAccessors laccForAndroidxRoomCompiler26LibraryAccessors = new AndroidxRoomCompiler26LibraryAccessors(owner);

        public AndroidxRoomCompiler2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.room.compiler.2.6</b>
         */
        public AndroidxRoomCompiler26LibraryAccessors get6() {
            return laccForAndroidxRoomCompiler26LibraryAccessors;
        }

    }

    public static class AndroidxRoomCompiler26LibraryAccessors extends SubDependencyFactory {

        public AndroidxRoomCompiler26LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>1</b> with <b>androidx.room:room-compiler.2.6.1</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> get1() {
            return create("androidx.room.compiler.2.6.1");
        }
    ...
    public static class LoggingInterceptorLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v4100</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         * with version reference <b>loggingInterceptorVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV4100() {
            return create("logging.interceptor.v4100");
        }
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v231</b> with <b>com.squareup.retrofit2:retrofit</b> coordinates and
         * with version reference <b>retrofitVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV231() {
            return create("retrofit.v231");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>loggingInterceptorVersion</b> with value <b>4.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>okhttp</b> with value <b>2.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>retrofitVersion</b> with value <b>2.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
